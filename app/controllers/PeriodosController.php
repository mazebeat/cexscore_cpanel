...
class PeriodosController extends BaseController
{
    ...
    public function store()
    {
        ...
        return Redirect::route('admin.periodos.create')->withInput()->withErrors($validation)->with('message', 'There were validation errors.');
    }
    ...
    public function update($id)
    {
        ...
        return Redirect::route('admin.periodos.edit', $id)->withInput()->withErrors($validation)->with('message', 'There were validation errors.');
    }
