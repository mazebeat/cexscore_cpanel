...
class PreguntaCabecera extends \Eloquent
{
    ...
    {
        $question1 = self::create(['descripcion_1' => 'Pregunta de Efectividad', 'numero_pregunta' => 1, 'id_tipo_respuesta' => 1, 'id_estado' => 1, 'id_categoria' => 1]);
        $question1 = $survey->preguntas()->save($question1);

        $subquestion1 = self::create([
        ...
        $question2 = self::create(['descripcion_1' => 'Pregunta de Facilidad', 'numero_pregunta' => 2, 'id_tipo_respuesta' => 1, 'id_estado' => 1, 'id_categoria' => 2]);
        $question2 = $survey->preguntas()->save($question2);

        $subquestion2 = self::create([
            'descripcion_1'     => '¿Por qué califica con esa nota? (opcional)',
        ...
        $question3 = self::create(['descripcion_1' => 'Pregunta de lo Grato de la interacción', 'numero_pregunta' => 3, 'id_tipo_respuesta' => 1, 'id_categoria' => 3]);
        $question3 = $survey->preguntas()->save($question3);

        $subquestion3 = self::create([
            'descripcion_1'     => '¿Por qué califica con esa nota? (opcional)',
