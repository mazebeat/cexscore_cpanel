...
class PreguntaCabecera extends \Eloquent
{
     ...
     */
    public static function generateDefaultQuestions(Encuesta $survey, $data = array())
    {
        $modify = false;
        ...
        try {
            if ($modify) {
                foreach ($data['preguntaCabecera'] as $key => $value) {
                    ...
                    $question1 = new PreguntaCabecera(['descripcion_1' => $value['descripcion_1'], 'numero_pregunta' => 1, 'id_tipo_respuesta' => 1, 'id_estado' => 1, 'id_categoria' => 1]);
