...
@section('content')
    ...
    {{ HTML::script('plugins/amcharts/plugins/responsive/responsive.js') }}
    {{ HTML::script('plugins/amcharts/plugins/export/export.js') }}
    {{ HTML::script('plugins/amcharts/lang/es.js') }}
