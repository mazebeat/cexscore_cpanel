...
<div class="form-group">
	...
	<div class="col-sm-10">
		{{ Form::select('usuario[genero]', ['' => '','F' => 'Femenino', 'M' => 'Masculino'], Input::old('usuario[genero]'), array('class'=>'form-control', 'placeholder'=>'Genero_usuario', 'required')) }}
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-10">
		{{ Form::select('usuario[rol_organizacion]', ['' => '', 'Servicio' => 'Servicio', 'Marketing' => 'Marketing', 'Ventas/Comercial' => 'Ventas/Comercial', 'Finanzas' => 'Finanzas', 'Dirección' => 'Dirección', 'Operaciones' => 'Operaciones'], Input::old('usuario[rol_organizacion]'), array('class'=>'form-control', 'required')) }}
	</div>
</div>
