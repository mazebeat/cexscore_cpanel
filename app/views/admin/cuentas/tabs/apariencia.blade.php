...
<div class="row">
	...
	<div class="form-group col-sm-6">
		...
		<div class="col-sm-8">
			{{ Form::select2('apariencia[color_opciones]', ['red' => 'Rojo', 'green' => 'Verde', 'blue' => 'Azul', 'grey' => 'Gris', 'orange' => 'Naranjo', 'yellow' => 'Amarillo', 'pink' => 'Rosado', 'purple' => 'Morado'], Input::old('apariencia[color_opciones]'), array('class'=>'form-control', 'placeholders'=>'Color Opciones')) }}
		</div>
	</div>
</div>
