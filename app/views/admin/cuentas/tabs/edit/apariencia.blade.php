...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::color('color_header', Input::old('color_header', $cliente->apariencias->first()->color_header), array('class'=>'form-control', 'placeholders'=>'Color_header')) }}
        </div>
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::color('color_body', Input::old('color_body', $cliente->apariencias->first()->color_body), array('class'=>'form-control', 'placeholders'=>'Color_body')) }}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::input('color', 'color_footer', Input::old('color_footer', $cliente->apariencias->first()->color_footer), array('class'=>'form-control', 'placeholders'=>'Color_footer')) }}
        </div>
    </div>
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::color('color_boton', Input::old('color_boton', $cliente->apariencias->first()->color_boton), array('class'=>'form-control', 'placeholders'=>'Color_boton')) }}
        </div>
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::color('color_text_header', Input::old('color_text_header',  $cliente->apariencias->first()->color_text_header), array('class'=>'form-control', 'placeholders'=>'Color_text_header')) }}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::color('color_text_body', Input::old('color_text_body',  $cliente->apariencias->first()->color_text_body), array('class'=>'form-control', 'placeholders'=>'Color_text_body')) }}
        </div>
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::color('color_text_footer', Input::old('color_text_footer',  $cliente->apariencias->first()->color_text_footer), array('class'=>'form-control', 'placeholders'=>'Color_text_footer')) }}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <div class="col-sm-8">
            {{ Form::color('color_instrucciones', Input::old('color_instrucciones',  $cliente->apariencias->first()->color_instrucciones), array('class'=>'form-control', 'placeholders'=>'Color_instrucciones')) }}
        </div>
    </div>
</div>
