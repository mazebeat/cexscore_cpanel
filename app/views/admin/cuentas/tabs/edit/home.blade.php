...
<div class="form-group">
	...
	<div class="col-sm-10">
		{{ Form::select('id_sector', $sectors, Input::old('id_sector'), array('id'=> 'id_sector', 'class'=>'form-control', 'required')) }}
...
<div class="form-group">
	...
	<div class="col-sm-10">
		{{ Form::text('direccion_cliente', Input::old('direccion_cliente'), array('id' => 'fieldCiudad', 'class'=>'form-control', 'placeholders'=>'Direcci&oacute;n Cliente' , 'required')) }}
