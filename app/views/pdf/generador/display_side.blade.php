<div class="container">
    <div class="row">
        <div class="col-xs-12  text-center" style="margin-bottom:20px; margin-top:20px;">
            <h2><img src="{{public_path($apariencia['logo_header'])}}" alt="Logo" style="max-height: 150px;"></h2>

            <h3>CONOCER TU EXPERIENCIA ES PARTE DE NUESTRO NEGOCIO</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12 text-center">
            <p><img src="{{public_path($URLrutaQR)}}" alt="Codigo QR" class="img-responsive" style="max-height: 200px"></p>
        </div>
    </div>
