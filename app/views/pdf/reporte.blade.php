...
@section('footer')
    <footer class="row" style="font-size: small;">
        ...
        <address class="text-center">
            ...
            <a href="http://customertrigger.com/" target="_blank">CustomerTrigger S.A.</a> {{ Carbon::now()->year }}<br> Direcci&oacute;n Comercial: Fanor Velasco No.85, Piso 9, Santiago | Direcci&oacute;n Legal: Sotero Del R&iacute;o 508, Oficina
            826, Santiago<br>
