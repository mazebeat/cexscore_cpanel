...
@section('footer')
    <footer class="row" style="font-size: small;">
        ...
        <address class="text-center">
            ...
            <a href="http://www.customertrigger.com/registro-zona-de-recursos/" target="_blank">Zona de Recursos</a> <br></br> Desarrollado por &copy;
            <a href="http://customertrigger.com/" target="_blank">CustomerTrigger S.A.</a> {{ Carbon::now()->year }}<br></br> Direcci&oacute;n Comercial: Fanor Velasco No.85, Piso 9, Santiago | Direcci&oacute;n Legal: Sotero Del R&iacute;o 508,
            Oficina
            826, Santiago<br></br>
